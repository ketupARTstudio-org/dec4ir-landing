// Replace placeholder values with actual contact info before launch
export const CONTACT = {
  email: 'mydrone@utm.my',
  emailHref: 'mailto:mydrone@utm.my',
...
export const REGISTRATION_URL = 'https://dec4ir.org'
